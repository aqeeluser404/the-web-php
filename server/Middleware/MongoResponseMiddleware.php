...
class MongoResponseMiddleware implements MiddlewareInterface {
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface {
        ...
        // Remove the problematic regex and just try to decode
        try {
            ...
            error_log('JSON error in MongoResponseMiddleware: ' . $e->getMessage());
            error_log('Raw body: ' . substr($rawBody, 0, 500)); // Log first 500 chars
            return $response;
        }
    }
